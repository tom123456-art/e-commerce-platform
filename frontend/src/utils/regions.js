 ...
 *
 * 数据来源说明：
 * - 本项目为演示用，已包含全部 34 个省级行政区（23 省 + 5 自治区 + 4 直辖市 + 2 特别行政区）
 * - 每个省/自治区/直辖市补全了主要的地级市（含部分直管县级市、州、地区），
 *   以及各地级市的代表性市辖区/县。县、县级市统一以名称字符串放入 districts，
 *   便于收货地址选择场景直接使用。
 * - 生产环境如需完整数据，可从国家统计局或 npm 包（如 china-division）获取。
 */
...
export const REGION_DATA = [
  ...
  },
  {
    ...
    cities: [{
      name: '重庆市',
      districts: ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '綦江区', '大足区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '城口县', '丰都县', '垫江县', '武隆区', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县']
    }]
  },
  ...
  // 23个省
  {
    name: '河北省',
    cities: [
      { name: '石家庄市', districts: ['长安区', '桥西区', '新华区', '裕华区', '藁城区', '鹿泉区', '栾城区', '正定县', '新乐市', '晋州市', '辛集市'] },
      { name: '唐山市', districts: ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '曹妃甸区', '遵化市', '迁安市', '滦州市', '玉田县'] },
      { name: '秦皇岛市', districts: ['海港区', '山海关区', '北戴河区', '抚宁区', '青龙满族自治县', '昌黎县', '卢龙县'] },
      { name: '邯郸市', districts: ['邯山区', '丛台区', '复兴区', '峰峰矿区', '肥乡区', '永年区', '武安市', '鸡泽县', '邱县', '曲周县', '馆陶县', '涉县', '魏县', '磁县'] },
      { name: '邢台市', districts: ['襄都区', '信都区', '任泽区', '南和区', '南宫市', '沙河市', '临城县', '内丘县', '柏乡县', '隆尧县', '宁晋县', '巨鹿县', '新河县', '广宗县', '平乡县', '威县', '清河县', '临西县'] },
      { name: '保定市', districts: ['竞秀区', '莲池区', '满城区', '清苑区', '徐水区', '涿州市', '定州市', '安国市', '高碑店市', '涞水县', '阜平县', '定兴县', '唐县', '高阳县', '容城县', '涞源县', '望都县', '易县', '曲阳县', '蠡县', '顺平县', '博野县', '雄县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '长治市', districts: ['潞州区', '上党区', '屯留区', '潞城区', '襄垣县', '平顺县', '黎城县', '壶关县', '长子县', '武乡县', '沁县', '沁源县', '长治县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '苏州市', districts: ['虎丘区', '吴中区', '相城区', '姑苏区', '吴江区', '工业园区', '常熟市', '张家港市', '昆山市', '太仓市'] },
  ...
  },
  {
    name: '福建省',
    cities: [
      { name: '福州市', districts: ['鼓楼区', '台江区', '仓山区', '晋安区', '马尾区', '长乐区', '闽侯县', '连江县', '罗源县', '闽清县', '永泰县', '平潭县', '福清市'] },
      ...
      { name: '漳州市', districts: ['芗城区', '龙文区', '云霄县', '漳浦县', '诏安县', '长泰区', '东山县', '南靖县', '平和县', '华安县', '龙海区'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '九江市', districts: ['浔阳区', '濂溪区', '柴桑区', '武宁县', '修水县', '永修县', '德安县', '都昌县', '湖口县', '彭泽县', '瑞昌市', '共青城市', '庐山市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '烟台市', districts: ['芝罘区', '福山区', '牟平区', '莱山区', '蓬莱区', '招远市', '莱州市', '龙口市', '莱阳市', '海阳市', '栖霞市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '洛阳市', districts: ['老城区', '西工区', '瀍河回族区', '涧西区', '偃师区', '孟津区', '洛龙区', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县'] },
      ...
      { name: '济源市', districts: ['沁园街道', '济水街道', '北海街道', '天坛街道', '玉泉街道', '克井镇', '五龙口镇', '轵城镇'] }
    ]
  },
  {
    name: '湖北省',
    cities: [
      ...
      { name: '荆州市', districts: ['沙市区', '荆州区', '公安县', '江陵县', '石首市', '洪湖市', '松滋市', '监利市'] },
      ...
      { name: '仙桃市', districts: ['干河街道', '龙华山街道', '沙嘴街道', '郑场镇', '毛嘴镇', '三伏潭镇'] },
      { name: '潜江市', districts: ['园林街道', '广华街道', '泰丰街道', '周矶街道', '杨市街道', '总口管理区'] },
      { name: '天门市', districts: ['竟陵街道', '侯口街道', '杨林街道', '多宝镇', '渔薪镇', '岳口镇'] },
      { name: '神农架林区', districts: ['松柏镇', '阳日镇', '木鱼镇', '红坪镇', '新华镇'] }
    ]
  },
  {
    name: '湖南省',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '肇庆市', districts: ['端州区', '鼎湖区', '广宁县', '怀集县', '封开县', '德庆县', '高要区', '四会市'] },
      ...
      { name: '东莞市', districts: ['莞城街道', '南城街道', '东城街道', '万江街道', '石碣镇', '石龙镇', '茶山镇', '虎门镇', '长安镇', '厚街镇'] },
      { name: '中山市', districts: ['石岐街道', '东区街道', '西区街道', '南区街道', '五桂山街道', '火炬开发区', '小榄镇', '古镇镇', '横栏镇', '东凤镇'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '儋州市', districts: ['那大镇', '白马井镇', '洋浦经济开发区', '兰洋镇', '中和镇'] },
      { name: '五指山市', districts: ['通什镇', '南圣镇', '毛阳镇', '番阳镇'] },
      { name: '琼海市', districts: ['嘉积镇', '博鳌镇', '潭门镇', '长坡镇'] },
      { name: '文昌市', districts: ['文城镇', '龙楼镇', '锦山镇', '铺前镇'] },
      { name: '万宁市', districts: ['万城镇', '兴隆镇', '龙滚镇', '和乐镇'] },
      { name: '东方市', districts: ['八所镇', '感城镇', '板桥镇', '大田镇'] },
      { name: '定安县', districts: ['定城镇', '翰林镇', '龙湖镇', '雷鸣镇'] },
      { name: '屯昌县', districts: ['屯城镇', '新兴镇', '枫木镇', '乌坡镇'] },
      { name: '澄迈县', districts: ['金江镇', '老城镇', '瑞溪镇', '福山镇'] },
      { name: '临高县', districts: ['临城镇', '调楼镇', '新盈镇', '波莲镇'] },
      { name: '白沙黎族自治县', districts: ['牙叉镇', '七坊镇', '邦溪镇', '打安镇'] },
      { name: '昌江黎族自治县', districts: ['石碌镇', '叉河镇', '十月田镇', '乌烈镇'] },
      { name: '乐东黎族自治县', districts: ['抱由镇', '黄流镇', '九所镇', '利国镇'] },
      { name: '陵水黎族自治县', districts: ['椰林镇', '英州镇', '光坡镇', '黎安镇'] },
      { name: '保亭黎族苗族自治县', districts: ['保城镇', '三道镇', '什玲镇', '新政镇'] },
      { name: '琼中黎族苗族自治县', districts: ['营根镇', '湾岭镇', '黎母山镇', '和平镇'] }
    ]
  },
  {
    name: '四川省',
    cities: [
      ...
      { name: '凉山彝族自治州', districts: ['西昌市', '会理市', '木里藏族自治县', '盐源县', '德昌县', '会东县', '宁南县', '普格县', '布拖县', '昭觉县', '金阳县', '雷波县', '美姑县', '甘洛县', '越西县', '喜德县', '冕宁县', '盐源县'] }
    ]
  },
  {
    name: '贵州省',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '普洱市', districts: ['思茅区', '宁洱哈尼族彝族自治县', '墨江哈尼族自治县', '景东彝族自治县', '景谷傣族彝族自治县', '镇沅彝族哈尼族拉祜族自治县', '江城哈尼族彝族自治县', '孟连傣族拉祜族自治县', '澜沧拉祜族自治县', '西盟佤族自治县'] },
  ...
  },
  {
    name: '陕西省',
    cities: [
      { name: '西安市', districts: ['新城区', '碑林区', '莲湖区', '雁塔区', '未央区', '灞桥区', '阎良区', '临潼区', '长安区', '高陵区', '鄠邑区', '蓝田县', '周至县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '嘉峪关市', districts: ['雄关街道', '钢城街道', '峪泉镇', '新城镇', '文殊镇'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '海西蒙古族藏族自治州', districts: ['格尔木市', '德令哈市', '茫崖市', '乌兰县', '都兰县', '天峻县', '大柴旦行委'] }
    ]
  },
  {
    name: '台湾省',
    cities: [
      ...
      { name: '新北市', districts: ['板桥区', '三重区', '中和区', '永和区', '新庄区', '新店区', '土城区', '芦洲区', '树林区', '莺歌区', '三峡区', '林口区', '淡水区', '汐止区', '瑞芳区', '万里区', '金山区', '深坑区', '石碇区', '平溪区', '双溪区', '贡寮区', '坪林区', '乌来区', '泰山区', '五股区', '八里区', '三芝区', '石门区'] },
      { name: '桃园市', districts: ['桃园区', '中坜区', '平镇区', '八德区', '杨梅区', '大溪区', '芦竹区', '龟山区', '龙潭区', '观音区', '新屋区', '复兴区'] },
      { name: '基隆市', districts: ['仁爱区', '信义区', '中正区', '中山区', '安乐区', '暖暖区', '七堵区'] },
      { name: '新竹市', districts: ['东区', '北区', '香山区'] },
      { name: '嘉义市', districts: ['东区', '西区'] },
      { name: '新竹县', districts: ['竹北市', '湖口乡', '新丰乡', '新埔镇', '关西镇', '芎林乡', '宝山乡', '竹东镇', '五峰乡', '尖石乡', '横山乡', '北埔乡', '峨眉乡'] },
      { name: '苗栗县', districts: ['苗栗市', '头份市', '竹南镇', '苑里镇', '通霄镇', '后龙镇', '卓兰镇', '大湖乡', '公馆乡', '铜锣乡', '三义乡', '西湖乡', '头屋乡', '狮潭乡', '泰安乡'] },
      { name: '彰化县', districts: ['彰化市', '员林市', '和美镇', '鹿港镇', '溪湖镇', '二林镇', '田中镇', '北斗镇', '花坛乡', '芬园乡', '大村乡', '埔盐乡', '埔心乡', '永靖乡', '社头乡', '二水乡', '田尾乡', '埤头乡', '芳苑乡', '大城乡', '竹塘乡', '线西乡', '伸港乡', '福兴乡', '秀水乡'] },
      { name: '南投县', districts: ['南投市', '埔里镇', '草屯镇', '竹山镇', '集集镇', '名间乡', '鹿谷乡', '中寮乡', '鱼池乡', '国姓乡', '水里乡', '信义乡', '仁爱乡'] },
      { name: '云林县', districts: ['斗六市', '斗南镇', '虎尾镇', '西螺镇', '土库镇', '北港镇', '古坑乡', '大埤乡', '莿桐乡', '林内乡', '二仑乡', '仑背乡', '麦寮乡', '东势乡', '褒忠乡', '元长乡', '四湖乡', '口湖乡', '水林乡'] },
      { name: '嘉义县', districts: ['太保市', '朴子市', '布袋镇', '大林镇', '民雄乡', '溪口乡', '新港乡', '六脚乡', '东石乡', '义竹乡', '鹿草乡', '水上乡', '中埔乡', '竹崎乡', '梅山乡', '番路乡', '大埔乡', '阿里山乡'] },
      { name: '屏东县', districts: ['屏东市', '潮州镇', '东港镇', '恒春镇', '万丹乡', '长治乡', '麟洛乡', '九如乡', '里港乡', '盐埔乡', '高树乡', '万峦乡', '内埔乡', '竹田乡', '新埤乡', '枋寮乡', '新园乡', '崁顶乡', '林边乡', '南州乡', '琉球乡', '佳冬乡', '枋山乡', '雾台乡', '玛家乡', '泰武乡', '来义乡', '春日乡', '狮子乡', '牡丹乡', '车城乡', '满州乡', '枋寮乡'] },
      { name: '宜兰县', districts: ['宜兰市', '罗东镇', '苏澳镇', '头城镇', '礁溪乡', '壮围乡', '员山乡', '冬山乡', '五结乡', '三星乡', '大同乡', '南澳乡'] },
      { name: '花莲县', districts: ['花莲市', '凤林镇', '玉里镇', '新城乡', '吉安乡', '寿丰乡', '光复乡', '丰滨乡', '瑞穗乡', '万荣乡', '卓溪乡', '富里乡'] },
      { name: '台东县', districts: ['台东市', '成功镇', '关山镇', '卑南乡', '鹿野乡', '池上乡', '东河乡', '长滨乡', '太麻里乡', '大武乡', '绿岛乡', '海端乡', '延平乡', '金峰乡', '达仁乡', '兰屿乡'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '喀什地区', districts: ['喀什市', '疏附县', '疏勒县', '英吉沙县', '泽普县', '莎车县', '麦盖提县', '岳普湖县', '伽师县', '巴楚县', '塔什库尔干塔吉克自治县'] },
  ...
  // 2个特别行政区
  {
    name: '香港特别行政区',
    cities: [
      { name: '香港', districts: ['中西区', '湾仔区', '东区', '南区', '九龙城区', '油尖旺区', '深水埗区', '黄大仙区', '观塘区', '荃湾区', '屯门区', '元朗区', '北区', '大埔区', '西贡区', '沙田区', '葵青区', '离岛区'] }
    ]
  },
  {
    name: '澳门特别行政区',
    cities: [
      { name: '澳门', districts: ['花地玛堂区', '圣安多尼堂区', '大堂区', '望德堂区', '风顺堂区', '嘉模堂区', '路氹填海区', '圣方济各堂区'] }
    ]
  }
]
 ...
 * @returns {Array} 区县数组（字符串列表），找不到时返回 []
 */
