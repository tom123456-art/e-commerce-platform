 ...
 * @createDate 2026-07-30 08:57:15
...
public interface CartItemMapper {
    ...
    /*查询用户购物车列表*/
    List<CartItemResponse>selestCartByUserId(@Param("userId") Long userId);
    ...
    int increaseQuantity(@Param("id") Long id, @Param("userId") Long userId, @Param("quantity") Integer quantity);
